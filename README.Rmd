...
The `.github/workflows/refresh-data.yaml` file contains the instructions to GitHub Actions to tell it to run `scrape_cash_rate.R` every 5 minutes and commit the results in this repo.
