...
function styleFrame(frame){
  try{
    ...
    if(!doc.getElementById('dashboard-chart-style')){const s=doc.createElement('style');s.id='dashboard-chart-style';s.textContent='body{margin:0!important;background:#fff!important;font-family:Arial,Helvetica,sans-serif!important}.js-plotly-plot .plotly text{font-family:Arial,Helvetica,sans-serif!important}@media(max-width:540px){.js-plotly-plot .plotly .gtitle{font-size:11px!important}.js-plotly-plot .plotly .legendtext{font-size:10px!important}}';doc.head.append(s);}
