...
"CPI", ymd_hm("2026-12-30 11:30", tz = "Australia/Melbourne"),
  ...
  "Labour Force", ymd_hm("2026-05-21 11:30", tz = "Australia/Melbourne"),
  "Labour Force", ymd_hm("2026-06-25 11:30", tz = "Australia/Melbourne"),
  "Labour Force", ymd_hm("2026-07-23 11:30", tz = "Australia/Melbourne"),
  "Labour Force", ymd_hm("2026-08-20 11:30", tz = "Australia/Melbourne"),
  "Labour Force", ymd_hm("2026-09-24 11:30", tz = "Australia/Melbourne"),
...
plotly_start_xlim <- format(as.POSIXct(start_xlim, tz = "Australia/Melbourne"), "%Y-%m-%d %H:%M:%S")
plotly_end_xlim <- format(as.POSIXct(end_xlim, tz = "Australia/Melbourne"), "%Y-%m-%d %H:%M:%S")
